...
<?php
 if(isset($_POST['year']) && isset($_POST['month'])){
    ...
    while($row = $res -> fetch_array()){
      $array_use = array();
      $count = 0;
      $q = 'SELECT * FROM request WHERE  YEAR(request_date) = "'.$_POST['year'].'"
                                   AND   MONTH(request_date) = "'.$_POST['month'].'"
                                   AND   request_assign = '.$row['van_no'].';';
       $res1 = $db -> query($q);
       while($row1 = $res1 -> fetch_array()){
         $count++;
       }
       $array_use['value'] = $count;
       $array_use['color'] = sprintf('#%06X', mt_rand(0, 0xFFFFFF));
       $array_use['highlight'] = $array_use['color'];
       $array_use['label'] = "Van number ".$row['van_no']." ";
...
<!-- ==============================For The Notification Menu============================================================= -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <center>
        <h1>
          Please Select The month to view data.
        </h1>
      </center>
    </section>
        ...
        <div class="box-body">
          <div class="form-group col-md-12">
            <div class="form-group" style="padding-top:10px">
                ...
                <form action="analysis_van.php" method="post" id="request_form">
                  <div class="form-group col-md-3">
                    <label>โปรดเลือกปี</label>
                    <div class="input-group date">
                      <div class="input-group-addon">
                        <i class="fa fa-calendar"></i>
                      </div>
                      <select name="year" class="form-control pull-right" required>
                      <?php
                         for($i = 2010 ; $i <= date('Y'); $i++){
                          if(isset($_POST['year']) && $i == $_POST['year']){
                  ...
                  <div class="form-group col-md-3">
                    <label>โปรดเลือกเดือน</label>
                    <div class="input-group date">
                      <div class="input-group-addon">
                        <i class="fa fa-calendar"></i>
                      </div>
                      <select name="month" class="form-control pull-right" required>
                      <?php
                         for($i = 1 ; $i <= 12; $i++){
                          if(isset($_POST['month']) && $i == $_POST['month']){
                            echo "<option value=".$i." selected>$i</option>";
                          }else{
                            echo "<option value=".$i.">$i</option>";
                          }
                ...
                <table id="example2" class="table table-bordered table-hover" style="width:100%;" align="center">
                  <thead>
                    <tr style="height:25px;">
                      <td style="text-align:center;width:40%;">หมายเลขรถ</td>
                      <td style="text-align:center;width:40%;">จำนวนงาน</td>
                  ...
                  <tbody>
                    <tr style="height:25px;">
                      <td style="text-align:center;width:30%;"><?php echo $json_arr[$i]['label']; ?></td>
                      <td style="text-align:center;width:40%;">จำนวน <?php echo $json_arr[$i]['value']; ?> งาน</td>
                      <td bgcolor=<?php echo $json_arr[$i]['color']; ?> style="text-align:center;"></td>
                    </tr>
                  </tbody>
                  <?php
                    }
